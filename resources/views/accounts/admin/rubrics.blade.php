        ...
        <div class="col-md-12">
            <form action="{{route('accounts.admin.rubrics')}}" method="POST">
                ...
                <table class="table table-striped add_input">
                    ...
                    <tr>
                        <td>
                            <div class="{{ $errors->has('rubrics') ? ' has-error' : '' }}">
                                <input type="text" value="{{$item}}" name="rubrics[]" class="form-control"></td>
                                @if ($errors->has('rubrics'))
                                <span class="help-block">
                                    <strong>{{ $errors->first('rubrics') }}</strong>
                                </span>
                                @endif
                            </div>
                        <td>
